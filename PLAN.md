...
| 2026-08-28 | **objects creep after they settle** | noted, not chased | With the house left alone and no drift, 23 of 203 objects still move up to 0.34m over about 25 seconds of simulated time. Not caused by A1a — identical with drift off. It matters because §2 says markers must be where you left them, and a mug that wanders a third of a metre is a marker that lies slowly. Worth its own experiment. |
